...
<script src="{{asset('resources/views/plugins/datatables/jszip.min.js')}}"></script>
<script src="{{asset('resources/views/plugins/datatables/pdfmake.min.js')}}"></script>
<script src="{{asset('resources/views/plugins/datatables/vfs_fonts.js')}}"></script>
<script src="{{asset('resources/views/plugins/datatables/buttons.html5.min.js')}}"></script>
